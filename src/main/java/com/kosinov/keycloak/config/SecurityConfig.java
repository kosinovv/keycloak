...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain resourceServerFilterChain(HttpSecurity http, OidcClientInitiatedLogoutSuccessHandler oidcLogoutSuccessHandler) throws Exception {
